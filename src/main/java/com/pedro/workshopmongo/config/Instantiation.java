...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2023") ,"Partiu viagem" , "Vou viajar para Sao Paulo" ,maria);
		Post post2 = new Post(null , sdf.parse("23/03/2023") , "Bom dia!" , "Acordei feliz",maria);
